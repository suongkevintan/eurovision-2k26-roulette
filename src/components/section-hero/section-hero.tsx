...
export function SectionHero({
  ...
  return (
    ...
    Aucun menu choisi à l&apos;avance. Aucune place assignée. Un tirage au sort. Un pays. Un moment du repas. Une recette à réaliser et à déguster sur fond de kitsch international assumé.
    </p>
    </div>
